...
namespace Persistence.Migrations
{
    ...
    [Migration("20230825211102_kidfjрвала")]
    partial class kidfjрвала
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.StorageRack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Entities.ProductAggregate.Cell", b =>
                {
                    b.HasOne("Domain.Entities.StorageRack", null)
                        .WithMany("Cells")
                    ...
                    b.OwnsOne("Domain.Entities.ProductAggregate.Type", "Type", b1 =>
                        {
                            ...
                            b1.HasKey("StorageRackId");

                            b1.ToTable("StorageRack");
